...
import SwiperSharedMedia from './SwiperSharedMedia'

function ContactInfo({toggleUpload}) {
	return (
		<div id="contact-info" className="pl-10 pr-10 pt-6">
      <div className="contact-info__profile mb-10">
        ...
        <div className="text-center">
          <div className="contact-info__profile__image inline-block mb-4 relative">
            <img className="contact-info__profile__img" src="./img/profile-avatar.png" alt="contact-info__profile__img" onClick={toggleUpload} />
            <i className="bi bi-check-circle-fill absolute bottom-0" />
          </div>
          <h2 className="contact-info__profile__name text-c_dark text-base mb-2 font-medium leading-4">Emilia Asobi</h2>
          <p className="contact-info__profile__title mb-0 text-c_gray leading-4">UI/UX Designer</p>
        </div>
      </div>
