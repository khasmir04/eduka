            ...
            <div className="h-screen pb-24 pt-2 pr-2 pl-2 md:pt-0 md:pr-0 md:pl-0">
              ...
              <div className="flex flex-col flex-wrap sm:flex-row ">
                <div className="w-full sm:w-1/2 xl:w-1/3">
                  <div className="mb-4">
                    <div className="shadow-sm border hover:cursor-pointer border-c_light rounded-2xl p-4 bg-white dark:bg-gray-700 w-full">
                      ...
                      <div className="block m-auto">
                        ...
                        <div className="w-full h-2 bg-gray-200 rounded-full mt-2">
                          <div className="w-1/2 h-full text-center text-xs text-white bg-primary rounded-full">
                          </div>
                        </div>
                      </div>
                      <div className="flex items-center justify-start my-4 space-x-4">
                        ...
                        <span className="px-2 py-1 flex items-center text-xs rounded-md text-primary font-semibold bg-blue-100">
                          UI/UX
                        </span>
                      </div>
                      <div className="flex -space-x-2">
                        <a href="#">
                          <img className="inline-block h-10 w-10 rounded-full object-cover ring-2 ring-white" src="img/users/contact-avatar-5.jpg" alt="Guy" />
                        </a>
                        <a href="#">
                          <img className="inline-block h-10 w-10 rounded-full object-cover ring-2 ring-white" src="img/users/contact-avatar-2.jpg" alt="Max" />
                        </a>
                        <a href="#">
                          <img className="inline-block h-10 w-10 rounded-full object-cover ring-2 ring-white" src="img/users/contact-avatar-3.jpg" alt="Charles" />
                        </a>
                        <a href="#">
                          <img className="inline-block h-10 w-10 rounded-full object-cover ring-2 ring-white" src="img/users/contact-avatar-4.jpg" alt="Jade" />
                        </a>
                      </div>
                ...
                <div className="w-full sm:w-1/2 xl:w-1/3">
                  <div className="mb-4 mx-0 sm:ml-4 xl:mr-4">
                    <div className="shadow-sm border hover:cursor-pointer border-c_light rounded-2xl bg-white dark:bg-gray-700 w-full">
                    ...
                    <div className="shadow-sm border hover:cursor-pointer border-c_light rounded-2xl bg-white dark:bg-gray-700 w-full">
                      ...
                      <div className="py-2 px-4 bg-blue-100 dark:bg-gray-800 text-gray-600 border-l-4 border-blue-500 flex items-center justify-between">
                        <p className="text-xs flex items-center dark:text-white">
                          <svg width={20} height={20} fill="currentColor" className="text-primary mr-2" viewBox="0 0 24 24">
                            <g fill="none">
                        ...
                        <div className="flex items-center">
                          ...
                          <button className="text-sm p-1 text-gray-400 border rounded bg-secondary mr-4">
                ...
                <div className="w-full sm:w-1/2 xl:w-1/3">
                  <div className="mb-4">
                    <div className="shadow-sm border hover:cursor-pointer border-c_light rounded-2xl p-4 bg-white dark:bg-gray-700">
                            ...
                            <table className="w-full dark:text-white">
                              <tbody><tr>
                                ...
                                <tr className="text-gray-400 dark:text-gray-500">
                                  ...
                                  <td className="py-3 px-2 md:px-3  hover:text-primary text-center text-gray-800 cursor-pointer">
                                    1
                                  </td>
                                </tr>
                                <tr>
                                  <td className="py-3 px-2 md:px-3  hover:text-primary text-center cursor-pointer">
                                    2
                                  </td>
                                  <td className="py-3 relative px-1  hover:text-primary text-center cursor-pointer">
                                    3
                                    <span className="absolute rounded-full h-2 w-2 bg-secondary bottom-0 left-1/2 transform -translate-x-1/2">
                                    </span>
                                  </td>
                                  <td className="py-3 px-2 md:px-3  hover:text-primary text-center cursor-pointer">
                                    4
                                  ...
                                  <td className="py-3 px-2 md:px-3 md:px-2 relative lg:px-3 hover:text-primary text-center cursor-pointer">
                                    8
                                ...
                                <tr>
                                  ...
                                  <td className="py-3 px-2 md:px-3  hover:text-primary relative text-center cursor-pointer">
                                    25
                      ...
                      <ul>
                        <li className="flex items-center my-6 space-x-2">
                          <a href="#" className="block relative">
                            <img alt="profil" src="img/users/contact-avatar-6.jpg" className="mx-auto object-cover rounded-full h-10 w-10 " />
                          </a>
                          <div className="flex flex-col">
                            ...
                            <span className="text-sm text-gray-400 dark:text-gray-300 ml-2">
                              Where's my black notebook ?
                            </span>
                          </div>
                        </li>
                        <li className="flex items-center my-6 space-x-2">
                          <a href="#" className="block relative">
                            <img alt="profil" src="img/users/contact-avatar-5.jpg" className="mx-auto object-cover rounded-full h-10 w-10 " />
                          </a>
                          <div className="flex flex-col">
                            <span className="text-sm text-gray-900 font-semibold dark:text-white ml-2">
                              Jojo
                            ...
                            <span className="text-sm text-gray-400 dark:text-gray-300 ml-2">
                              We still need to find Dio
                            </span>
                          </div>
                        </li>
                        <li className="flex items-center my-6 space-x-2">
                          <a href="#" className="block relative">
                            <img alt="profil" src="img/users/contact-avatar-8.jpg" className="mx-auto object-cover rounded-full h-10 w-10 " />
                          </a>
                          <div className="flex flex-col">
                            <span className="text-sm text-gray-900 font-semibold dark:text-white ml-2">
                              Razzie Binx
                            ...
                            <span className="text-sm text-gray-400 dark:text-gray-300 ml-2">
                              Live tomorrow! Don't forget
                            </span>
                          </div>
                        </li>
                        <li className="flex items-center my-6 space-x-2">
                          <a href="#" className="block relative">
                            <img alt="profil" src="img/users/contact-avatar-7.jpg" className="mx-auto object-cover rounded-full h-10 w-10 " />
                          </a>
                          <div className="flex flex-col">
                            <span className="text-sm text-gray-900 font-semibold dark:text-white ml-2">
                              Mike Wazowski
