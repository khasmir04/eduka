      ...
      <section id="overview" className="p-5">
        <div className="w-full mb-6">
          <div className="flex flex-wrap">
            <div className="w-full lg:w-8/12 pr-6">
              <div className="mb-5">
                <h1 className="text-xl font-bold">Hello, E-koursipper</h1>
              </div>
              <div className="flex card-1">
                <div className="w-full lg:w-8/12">Chart</div>
                ...
                <div className="flex">
                  <div className="w-full py-6 px-8">
                    ...
                    <div className="illustration flex items-center mb-8">
                      <img className="mr-3" src="/img/illu-image.svg" alt="" />
                      <div className="flex flex-col mr-auto">
        ...
        <div className="w-full">
          <div className="flex">
            <div className="w-full lg:w-8/12 pr-6 ">
              <div className="flex">
                <div className="w-full lg:w-6/12 mr-6">
                  <div className="card-1 p-4">
                    <div className=" bg-gray-700 py-32 w-full h-full sm:rounded-t-3xl"></div>
                    <div></div>
                  </div>
                  <div className=" bg-white py-9 px-9 sm:rounded-xl -mt-14 mx-2 ">
                    <div className="flex justify-evenly mb-4">
                      <span className="text-xl font-bold">
                        Programming - Exam
                      </span>
                      <span className="pt-4 text-yellow-400 text-sm">
                        Details
                      </span>
                    </div>
                    <div className="flex ">
            ...
            <div className="w-full lg:w-4/12">
              <div>
                <div className="card-1 py-7 px-8">
                  <div className="flex justify-between">
