						...
						<div className="mt-12">
							<form>
								<div>
									...
									<input className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="text" placeholder="khaz@gmail.com" />
								</div>
								<div className="mt-8">
								...
								<div className="mt-10">
								<Link href="/dashboard" onClick={e => (!name || !room) ? e.preventDefault() : null}>
